...
const PUSH_JOURNEY_CONFIGS: Record<string, {
  ...
  onboarding: {
    ...
    steps: [
      ...
      {
        stepOrder: 3,
        name: "Day 3 Trust Stack",
        payload: {
          title: "⭐ Your trust stack score: see how to improve",
          body: "Top agents score 80+. Here's exactly how to get there.",
          category: "journey",
          link: "/scan",
        },
        type: "delay",
      ...
      {
        stepOrder: 4,
        name: "Day 7 Ranking Pulse",
        payload: {
          title: "🏆 Weekly ranking pulse",
          body: "Check your local SEO position vs. your competitors.",
          category: "journey",
          link: "/competitors",
        },
        type: "delay",

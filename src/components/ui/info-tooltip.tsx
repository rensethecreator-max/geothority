...
> = {
  ...
  5: {
    ...
    why: "ChatGPT, Perplexity, Google AI, Claude, Copilot, Grok, DeepSeek, and Meta AI are replacing traditional search. Without proper schema and entity markup, AI won't know you exist.",

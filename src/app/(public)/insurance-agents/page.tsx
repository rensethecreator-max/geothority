...
const painPoints = [
  ...
  },
  {
    ...
    solution: "ChatGPT, Perplexity, and Claude pull from the same signals as Google. Geothority optimizes you for both traditional search and AI discovery simultaneously.",
  },
];

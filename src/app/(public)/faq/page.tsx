  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Geothority is a local SEO and GEO (Generative Engine Optimization) platform built specifically for insurance agents and local businesses. It runs a 90-second website audit, scores your online presence across 5 trust layers, and gives you copy-paste fixes to rank higher in Google Maps, organic search, and AI answers like ChatGPT and Google AI Overviews.",
      },
    },
    {
      "@type": "Question",

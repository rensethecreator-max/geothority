              ...
              >
                ...
                <ul className="space-y-2.5 flex-1">
                  ...
                  <li className="flex items-center gap-2.5 text-sm text-gray-300">
                    ...
                    <GeoTooltip tip="Checks if ChatGPT, Perplexity, Google AI, Claude, Copilot, Grok, DeepSeek, Meta AI, You.com, and Mistral recommend your business when customers search for your services." side="top" iconClassName="w-3 h-3 opacity-40 hover:opacity-100" />
                  </li>
            ...
            <div className="bg-[#0f1117] border border-white/10 rounded-2xl p-8 overflow-x-auto">
              <table className="w-full">
                ...
                <tbody>
                  ...
                  <FeatureRow label="AI Search Tracker" free="Demo" starter="Full" growth="Full" authority="Full + Monitor" tip="Checks whether ChatGPT, Perplexity, Google AI, Claude, Copilot, Grok, DeepSeek, Meta AI, You.com, and Mistral recommend your business when customers ask. Full + Monitor means we track changes over time and alert you." />

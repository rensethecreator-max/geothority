...
const cities: Record<string, {
  ...
  "austin": {
    ...
    faqs: [
      ...
      { q: "Does Austin's tech-heavy population affect local SEO?", a: "Yes - Austin searchers are more likely to use AI assistants for local recommendations. Geothority's AI Overview Checker helps you appear in ChatGPT, Perplexity, and Claude results." },
  ...
  "atlanta": {
    ...
    faqs: [
      ...
      { q: "Is AI search important for Atlanta businesses?", a: "Yes - Atlanta has a large tech-forward professional population that uses AI assistants heavily. Geothority's AI Overview Checker ensures you appear in ChatGPT, Perplexity, and Claude recommendations." },
    ],
  },
  "dallas": {
    slug: "dallas",
